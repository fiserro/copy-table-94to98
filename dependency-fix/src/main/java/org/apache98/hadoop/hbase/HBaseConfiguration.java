 ...
 */
package org.apache98.hadoop.hbase;
...
import org.apache98.hadoop.hbase.util.VersionInfo;
...
public class HBaseConfiguration extends Configuration {
	...
	public static Configuration addHbaseResources(Configuration conf) {
		conf.addResource("hbase-default98.xml");
		conf.addResource("hbase-site98.xml");
	...
	public static boolean isShowConfInServlet() {
		...
		try {
			if (Class.forName("org.apache98.hadoop.conf.ConfServlet") != null) {
				isShowConf = true;
			}
